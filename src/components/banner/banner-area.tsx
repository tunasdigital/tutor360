       ...
       <div className="row">
          <div className="col-lg-6">
             <div className="tp-banner-sm-2-wrap mb-60 wow fadeInUp" data-wow-delay=".3s">
                <h3 className="tp-banner-sm-2-title">Conquiste seu <br/> 
                    <span>Certificado
                ...
                <div className="tp-banner-sm-2-btn">
                   <Link href="/course-categories">Ver Programas</Link>
                </div>
          ...
          <div className="col-lg-6">
             <div className="tp-banner-sm-2-wrap tp-banner-sm-2-bg-2 mb-60 wow fadeInUp" data-wow-delay=".3s">
                <h3 className="tp-banner-sm-2-title">Cursos mais <br/>Avaliados e  
                    <span>Populares
                ...
                <div className="tp-banner-sm-2-btn">
                   <Link href="/course-with-filter">Ver Programas</Link>
                </div>
                <div className="tp-banner-sm-2-shape-1">
