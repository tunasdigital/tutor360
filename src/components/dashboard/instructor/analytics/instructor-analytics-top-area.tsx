...
// Fact data - Dicionário de métricas nacionalizado
const factData = [
   { id: 1, count: 84, label: 'Matrículas', icon: enroll_icon, colorClass: 'common-pale-yellow' },
   { id: 2, count: 145, label: 'Total de Alunos', icon: student_icon, colorClass: 'common-pale-green' },
   { id: 3, count: 26, label: 'Total de Avaliações', icon: star_icon, colorClass: 'common-pale-purple' },
];
               ...
               <div className="col-lg-4" key={fact.id}>
                  <div className="tp-fact-item d-flex align-items-center justify-content-between">
                     <div className="tp-fact-content">
                        ...
                        {/* A label agora renderiza os termos em português definidos no factData */}
                        <span>{fact.label}</span>
                     </div>
                     <div className="tp-fact-icon">
                        <span className={fact.colorClass}>
                           <Image src={fact.icon} alt="ícone de métrica" />
                        </span>
                     </div>
                  </div>
               </div>
