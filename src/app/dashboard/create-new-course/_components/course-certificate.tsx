                ...
                <div key={certificate.id} className="col-lg-4 col-sm-6">
                  ...
                  >
                    ...
                    {selectedTemplate === certificate.id && (
                      <div style={{
                        position: 'absolute', top: '-10px', right: '10px', backgroundColor: '#0055FF', color: '#fff', 
                        borderRadius: '50%', width: '24px', height: '24px', display: 'flex', alignItems: 'center', 
                        justifyContent: 'center', fontSize: '12px', fontWeight: 'bold', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.2)'
                      }}>
                        ✓
                      </div>
                    )}
