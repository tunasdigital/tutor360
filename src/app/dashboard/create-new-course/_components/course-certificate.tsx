                        ...
                        <div key={certificate.id} className="col-lg-4 col-sm-6">
                           ...
                           >
                              <Image 
                                 ...
                                 alt="Certificado" 
                                 width={215} height={276} 
                                 style={{
                                    height: 'auto', 
                                    border: selectedCertificate === certificate.id ? '3px solid #0055FF' : '1px solid #EAEAEA', 
                                    borderRadius: '8px', padding: '5px', transition: 'all 0.3s ease',
                                    pointerEvents: 'none'
                                 }} 
                              />
                              {selectedCertificate === certificate.id && (
                                 <div style={{ position: 'absolute', top: '-10px', right: '10px', backgroundColor: '#0055FF', color: '#fff', borderRadius: '50%', width: '24px', height: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 'bold', zIndex: 20 }}> ✓ </div>
                              )}
                           </div>
                        </div>
                     ))}
